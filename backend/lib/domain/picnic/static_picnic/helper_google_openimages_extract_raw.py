...
def main():
    label_hierarchy_path = "bbox_labels_600_hierarchy.json" # download this file from google openimages dataset: https://storage.googleapis.com/openimages/web/download_v7.html
    label_parents = load_label_hierarchy(label_hierarchy_path)

    class_descriptions_path = "class-descriptions-boxable.csv" # download this file from google openimages dataset: https://storage.googleapis.com/openimages/web/download_v7.html
    ...
    annotations_path = "train-annotations-human-imagelabels.csv" # download this file from google openimages dataset: https://storage.googleapis.com/openimages/web/download_v7.html
    ...
    with open("/data/open_images_combined_items.json", "w") as f:
    ...
    with open("/data/open_images_unique_tags.json", "w") as f:
