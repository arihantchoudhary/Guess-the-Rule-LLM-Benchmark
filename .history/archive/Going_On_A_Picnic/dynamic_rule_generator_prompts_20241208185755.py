...
def L1_generate_attribute_based_rule_prompt(existing_rules=None):
    ...
    prompt = f"""
You are the game master for "Guess the Rule Games." {existing_rules_text}Your task is to create a **unique and simple attribute-based rule** that determines which items can be brought to the game.
...
def L1_generate_categorical_rule_prompt(existing_rules=None):
    ...
    prompt = f"""
You are the game master for "Guess the Rule Games." {existing_rules_text}Your task is to create a **unique and simple categorical rule** that determines which items can be brought to the game.
...
def L1_generate_relational_rule_prompt(existing_rules=None):
    ...
    prompt = f"""
You are the game master for "Guess the Rule Games." {existing_rules_text}Your task is to create a **unique and simple relational rule** that determines which pairs of items can be brought to the game.
...
def L1_generate_logical_rule_prompt(existing_rules=None):
    ...
    prompt = f"""
You are the game master for "Guess the Rule Games." {existing_rules_text}Your task is to create a **unique and simple logical rule** that determines which items can be brought to the game.
...
def L1_generate_semantic_rule_prompt(existing_rules=None):
    ...
    prompt = f"""
You are the game master for "Guess the Rule Games." {existing_rules_text}Your task is to create a **unique and simple semantic rule** that determines which items can be brought to the game.
